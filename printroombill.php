<?php
    ...
    $qry1 = "SELECT * FROM `acroom` WHERE `id`='$_SESSION[roomid]'";
                    ...
                    <tbody>
                        <tr width="25%">
                            <td class="text-left">
                                ...
                                ?>
                                <div>
                                    <p class="key">Room Type:</p>
                                    <p class="value"><?=$type?></p>
                                    <br />
                                    <p class="key">Check In Date:</p>
                                    <p class="value"><?=$_SESSION['post']['intime']?></p>
                                    <br />
                                    <p class="key">Check Out Date:</p>
                                    <p class="value"><?=$_SESSION['post']['outtime']?></p>
                                    <br />
                                    <p class="key">Total Members:</p>
                                    <p class="value"><?=$_SESSION['post']['members']?></p>
                                    <br />
                                </div>
                            </td>
                            <td></td>
