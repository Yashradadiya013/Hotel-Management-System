    ...
    <div class="register popup modal-dialog modal-dialog-centered" role="document">
        <form class="modal-content" action="login_register.php" method="POST">
            ...
            <div class="modal-body">
                ...
                <input type="mobile" placeholder="Mobile No" pattern="[0-9]{10}" name="mno" required>
                <input type="text" placeholder="Adhar Card No"  pattern="[0-9]{12}" max="12" name="adno" required>
            </div>
