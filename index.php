...
<body>
    ...
    <section class="container speciality-class box-shadow-all">
        ...
        <div class="row-data" id="services">
            <div class=" box box-shadow-all">
                <a href="food.php"><img class="card-img" src="img/manchu2.jpg"" alt="manchurion"></a>
            ...
            <div class=" box box-shadow-all">
                <a href="food.php"><img class="card-img" class="card-img" src="img/pasta 2.jpg" alt="pasta"></a>
            ...
            <div class=" box box-shadow-all">
                ...
                <p class="p-secondary">The most-popular forms are bhaji, vada pav, misalpav,special thali and pav bhaji.
                    More-traditional
            ...
            <div class=" box box-shadow-all">
                <a href="food.php"><img class="card-img" src="img/Dal.jpg" alt="dal makhani"></a>
    ...
    <section id="booking-hall">
        <a href="food.php"><img class="img-fluid hall-img" src="img/hall8.jpg" alt="hall" /></a>
        <div class="hall-div">
